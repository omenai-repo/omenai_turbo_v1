// app/fairs-events/[event_id]/FairEventHero.tsx
"use client";
...
export const FairEventHero = ({ event }: { event: any }) => {
  // ── 1. Image resolution: installation_views array takes strict priority ──
  const hasInstallationViews =
    Array.isArray(event.installation_views) &&
    event.installation_views.length > 0;
  ...
  const eventLabel = (event.event_type as string)
    .replace(/_/g, " ")

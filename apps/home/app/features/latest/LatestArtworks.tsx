    ...
    <div className="max-h-[180vh] h-auto overflow-hidden relative">
      ...
      <div className="h-[35vh] w-full absolute z-10 bottom-0 flex items-center justify-center">
        ...
        <Link href={"/catalog"} className="group absolute bottom-16">
          <button className="flex items-center gap-x-2  shadow-[8px_8px_0px_rgba(0,0,0,1)] group-hover:shadow-none duration-200 bg-white ring-1 ring-dark text-dark mt-10 z-20 rounded px-8 py-1 text-fluid-xxs">
            See more

export const artMediumHistory = {
  ...
  "Works on paper":
    "Works on paper represents one of the most versatile and enduring art mediums, encompassing drawings, prints, watercolors, pastels, and mixed media pieces created on various paper supports. Its history spans centuries and reflects both technological innovation and evolving artistic practices.",
};
...
export const collections: { title: string; url: string }[] = [
  ...
  { title: "Mixed media on canvas/paper", url: "mixed-media_art" },

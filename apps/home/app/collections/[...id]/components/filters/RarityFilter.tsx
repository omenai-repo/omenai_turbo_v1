  ...
  return (
    <div className="p-2 md:relative w-full md:w-fit">
      <div
        ...
        className="ring-1 whitespace-nowrap rounded-xl cursor-pointer ring-[#e0e0e0] font-normal text-[13px] text-dark flex justify-between items-center px-3 h-[35px] hover:bg-[#FAFAFA] hover:ring-dark"
      >

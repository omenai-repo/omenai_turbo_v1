...
export default function Dimensions({ dimensions }: DimensionsProps) {
  return (
    <div className="">
      <h6 className="text-dark/80 text-[14px] font-semibold">Dimensions:</h6>

      <div className="w-full grid grid-cols-2 gap-x-6">
        <div>
          <div className="text-[14px] font-semibold">
            <ul className="w-full grid grid-cols-2 text-dark/80 justify-center gap-y-3 py-4 font-normal">
              <div>

...
export default function ArtistInformation({
  ...
  return (
    <div className=" my-5 w-full text-dark/80">
      ...
      <div className="w-full border rounded-[20px] mt-4 border-dark/10 text-dark/80 justify-center gap-y-3 py-4 font-normal text-[14px]">

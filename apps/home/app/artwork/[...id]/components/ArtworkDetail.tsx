...
export default function ArtworkDetail({ data, sessionId }: ArtworkDetailTypes) {
  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <div className="flex flex-wrap items-center gap-4 border-y border-neutral-100 py-4">
      ...
      {/* 4. PRICE & STATUS */}
      <div className="py-4">
        <span className="mb-2 block font-mono text-[9px] uppercase tracking-widest text-neutral-400">
          Valuation
        </span>
        {isSoldOut ? (
          <span className="inline-block border border-neutral-200 bg-neutral-50 px-3 py-1 font-mono text-xs uppercase tracking-widest text-neutral-500">
            Acquired
          </span>
        ) : (
      ...
      <div className="flex flex-col gap-4">
        ...
        <button
          ...
          className="group flex h-14 w-full items-center justify-center gap-3 bg-dark text-white transition-all duration-300 hover:bg-neutral-800 disabled:cursor-not-allowed disabled:bg-neutral-200 disabled:text-neutral-500 rounded-none"
        >
        ...
        <button
          ...
          className="group flex h-14 w-full items-center justify-center gap-3 border border-neutral-200 bg-white text-dark transition-all duration-300 hover:border-black rounded-none"
        >
          {sessionId && likedState.ids.includes(sessionId) ? (
            ...
            <>
              ...
              <IoHeartOutline className="text-neutral-400 group-hover:text-dark transition-colors" />
            </>
          )}
        </button>
      </div>

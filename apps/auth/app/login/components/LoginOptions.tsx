...
export default function LoginOptions() {
  return (
    <div className="w-full grid place-items-center">
      <div className="grid grid-cols-2 grid-rows-3 font-medium w-full gap-5 items-center justify-center">
        ...
        <Link href={"/register"} className="w-full items-center col-span-2">
          <button className="bg-dark hover:bg-dark/80 text-white focus:ring ring-1 border-0 ring-dark/20 focus:ring-white duration-300 outline-none focus:outline-none  rounded-full h-[40px] p-6 w-full text-center text-[14px] flex items-center justify-center hover:ring-white cursor-pointer">
            Create an account
          </button>
        </Link>
      </div>

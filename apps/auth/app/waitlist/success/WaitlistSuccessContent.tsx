    ...
    <>
      ...
      <div className="z-10 max-w-[540px] text-center flex flex-col items-center gap-6">
        ...
        <motion.a
          ...
          type="submit"
          className=" p-4 rounded-full w-full flex items-center justify-center gap-3 disabled:cursor-not-allowed disabled:bg-dark/10 disabled:text-[#A1A1A1] bg-dark text-white text-fluid-base font-medium"
          href={base_url()}
        >
          Explore Omenai
        </motion.a>

  ...
  return (
    <form className="space-y-6" onSubmit={handleSubmit}>
      ...
      <button
        ...
        className="flex h-11 w-full items-center justify-center rounded bg-slate-900 px-4 text-sm font-medium text-white transition-all hover:bg-slate-800 disabled:cursor-not-allowed disabled:bg-slate-100 disabled:text-slate-400"
      >

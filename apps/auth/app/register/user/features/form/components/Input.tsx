      ...
      >
        ...
        <div className="w-full relative">
          <input
            ...
            className="disabled:cursor-not-allowed disabled:bg-dark/10 focus:ring ring-1 border-0 ring-dark/20 outline-none focus:outline-none focus:ring-dark transition-all duration-200 ease-in-out h-[35px] p-5 rounded-full w-full text-xs placeholder:text-xs placeholder:text-gray-700/40 placeholder:font-medium font-medium"

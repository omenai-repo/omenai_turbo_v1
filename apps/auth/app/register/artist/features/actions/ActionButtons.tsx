  ...
  return (
    <div className="w-full flex gap-4">
      <button
        ...
        }  border border-slate-400   bg-transparent text-dark hover:border-slate-800 disabled:cursor-not-allowedfocus:ring-0 duration-300 outline-none focus:outline-none disabled:bg-dark/10 disabled:text-white rounded-full h-[35px] p-5 w-full text-center text-fluid-xxs flex items-center justify-center hover:ring-white cursor-pointer`}
        type={"button"}

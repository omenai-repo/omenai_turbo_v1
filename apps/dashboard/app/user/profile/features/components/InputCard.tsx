    ...
    <div className="flex flex-col space-y-2">
      ...
      <div className={clsx("flex items-center justify-between py-1 px-1")}>
        <input
          ...
          className="focus:ring ring-1 border-0 ring-dark/20 outline-none focus:outline-none focus:ring-dark transition-all duration-200 ease-in-out h-[35px] p-5 rounded-md text-fluid-xs placeholder:text-dark/40 w-full disabled:cursor-not-allowed disabled:bg-dark/10 disabled:text-[#858585]"
        />
      </div>
    </div>
  );

...
export default function UpdateLogoModalForm() {
  ...
  return (
    <div className="bg-white rounded-sm  max-w-md w-full p-6 shadow-2xl animate-slideUp h-full overflow-y-auto">
      <h3 className="text-fluid-sm font-medium text-dark mb-4">Update Logo</h3>
      <div className="space-y-4">
        <div className="border-2 border-dashed border-line rounded-sm  p-8 text-center cursor-pointer hover:border-dark transition-colors duration-300">
        ...
        <div className="flex space-x-3">
          <button
            ...
            className="flex-1 px-4 py-2.5 bg-gray-300 text-dark rounded-sm  hover:bg-gray-400 
                       transition-all duration-300 text-fluid-xxs font-normal"
          >
            Cancel
          </button>
          <button
            className="flex-1 px-4 py-2.5 bg-dark text-white rounded-sm  hover:bg-dark/90 
                             transition-all duration-300 text-fluid-xxs font-normal"
          >
            Upload
          </button>

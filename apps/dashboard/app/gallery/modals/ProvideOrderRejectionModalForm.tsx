        ...
        <div className="space-y-4 mb-2 flex flex-col w-full">
          <div className="relative w-full h-auto my-2">
            ...
            <textarea
              ...
              className="w-full focus:ring ring-1 border-0 ring-dark/20 outline-none focus:outline-none focus:ring-dark transition-all duration-200 ease-in-out p-6 rounded-[20px] placeholder:text-dark/40 text-fluid-xs font-medium placeholder:text-fluid-xs"
            />
          </div>
        </div>

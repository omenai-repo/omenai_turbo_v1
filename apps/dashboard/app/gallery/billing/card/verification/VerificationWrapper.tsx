...
export const PaymentMethodSuccessScreen = ({ isVisible = true }) => {
  ...
  const SuccessScreen = () => (
    <div className="bg-white rounded-sm  shadow-2xl max-w-md w-full mx-auto overflow-hidden">
      ...
      <div className="bg-gradient-to-br from-green-500 to-emerald-600 px-8 pt-12 pb-8 text-white relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-0 left-0 w-32 h-32 rounded-sm  bg-white transform -translate-x-16 -translate-y-16"></div>
          <div className="absolute bottom-0 right-0 w-24 h-24 rounded-sm  bg-white transform translate-x-12 translate-y-12"></div>
          <div className="absolute top-1/2 left-1/2 w-16 h-16 rounded-sm  bg-white transform -translate-x-8 -translate-y-8"></div>
        </div>
        ...
        <div className="relative z-10 flex flex-col items-center">
          ...
          >
            <div className="w-20 h-20 bg-white bg-opacity-20 rounded-sm  flex items-center justify-center backdrop-blur-sm">
              <CheckCircle
                size={48}
            ...
            {/* Pulse rings */}
            <div
              className={`absolute inset-0 rounded-sm  border-2 border-white opacity-30 transform transition-all duration-1000 ${
                animateIcon ? "scale-150 opacity-0" : "scale-100 opacity-30"
              }`}
            ></div>
            <div
              className={`absolute inset-0 rounded-sm  border-2 border-white opacity-20 transform transition-all duration-1000 delay-200 ${
      ...
      >
        ...
        <div className="flex items-center justify-between mb-8 p-4 bg-gray-50 rounded-sm ">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 bg-gradient-to-br from-green-500 to-emerald-600 rounded-sm  flex items-center justify-center text-white shadow-lg">
              <CreditCard size={24} />
            </div>
            <div>
          ...
          <div className="bg-green-100 text-green-800 px-3 py-1 rounded-sm  text-sm font-medium flex items-center gap-1">
        ...
        <Link href={"/gallery/billing"}>
          <button className="w-full bg-gradient-to-r text-fluid-xxs from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 hover:shadow-lg text-white font-semibold py-4 px-6 rounded-sm  transform transition-all duration-200 hover:scale-105 active:scale-95 flex items-center justify-center gap-2">
            <ArrowLeft size={18} />
  ...
  const ErrorScreen = () => (
    <div className="bg-white rounded-sm  shadow-2xl max-w-md w-full mx-auto overflow-hidden">
      ...
      >
        {/* Error message */}
        <div className="flex items-start gap-4 mb-8 p-4 bg-red-50 rounded-sm  border border-red-100">
          <div className="w-12 h-12 bg-gradient-to-br from-red-500 to-red-600 rounded-sm  flex items-center justify-center text-white shadow-lg flex-shrink-0">
        ...
        <div className="space-y-3 flex flex-col">
          <button
            ...
            className="w-full bg-gradient-to-r text-fluid-xxs from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 hover:shadow-lg text-white font-semibold py-4 px-6 rounded-sm  transform transition-all duration-200 hover:scale-105 active:scale-95 flex items-center justify-center gap-2"
          >
            <RefreshCw size={18} />
            Try Again
          </button>
          <Link href={"/gallery/billing"}>
            <button className="w-full bg-gray-100 hover:bg-gray-200 text-gray-700 font-semibold py-4 px-6 rounded-sm  transform transition-all duration-200 hover:scale-105 active:scale-95 flex items-center justify-center gap-2">
              <ArrowLeft size={18} />
              Back to billing page
            </button>
          </Link>
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          ...
          {!showSuccess && (
            <button
              ...
              className="bg-green-600 hover:bg-green-700 text-white font-medium px-6 py-3 rounded-sm  transition-colors"
            >
              Show Success Screen
            </button>
          )}
        ...
        {!showSuccess && (
          <div className="text-center py-16">
            <div className="bg-white rounded-sm  p-8 shadow-lg max-w-md mx-auto">

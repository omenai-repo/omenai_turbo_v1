...
export const PaymentMethodChangeForm = () => {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4 pb-4">
      <div className="p-6 border border-slate-200 rounded">
        <PaymentElement />
      </div>

    ...
    <>
      <div className=" space-y-4 mb-4 w-full">
        ...
        <button
          ...
          className="w-full py-3 bg-dark grid place-items-center text-white text-fluid-xxs font-medium rounded-full disabled:bg-dark/30 disabled:cursor-not-allowed hover:bg-dark/90 transition-colors"
        >

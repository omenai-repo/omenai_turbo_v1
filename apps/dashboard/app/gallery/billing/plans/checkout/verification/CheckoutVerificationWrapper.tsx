...
const LoadingState = () => (
  <div className="w-full max-w-sm bg-white rounded-sm  -lg border border-slate-100 shadow-xl shadow-slate-200/50 p-10 text-center">
    <div className="flex justify-center mb-6">
      <div className="relative">
        <div className="absolute inset-0 bg-emerald-100 rounded-sm  -full blur-xl opacity-50"></div>
...
const SuccessState = ({
  ...
  <div
    className={`w-full max-w-sm bg-white rounded-sm  -lg border border-slate-100 shadow-xl shadow-slate-200/50 p-8 text-center transition-all duration-700 ${
      showContent ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
    }`}
  >
    <div className="flex justify-center mb-6">
      <div className="w-16 h-16 bg-emerald-50 rounded-sm  -full flex items-center justify-center">
    ...
    <Link
      ...
      className="block w-full rounded-sm  bg-slate-900 py-3 text-sm font-medium text-white hover:bg-slate-800 transition focus:outline-none focus:ring-2 focus:ring-slate-900 focus:ring-offset-2"
    >
      View Subscription
    </Link>
...
const ErrorState = ({
  ...
  <div
    className={`w-full max-w-sm bg-white rounded-sm  -lg border border-red-100 shadow-xl shadow-red-100/50 p-8 text-center transition-all duration-700 ${
      showContent ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
    }`}
  >
    <div className="flex justify-center mb-6">
      <div className="w-16 h-16 bg-red-50 rounded-sm  -full flex items-center justify-center">
    ...
    <Link
      href="/gallery/billing"
      className="group flex items-center justify-center gap-2 w-full rounded-sm  border border-slate-200 bg-white py-3 text-sm font-medium text-slate-700 hover:bg-slate-50 hover:text-slate-900 transition focus:outline-none focus:ring-2 focus:ring-slate-200 focus:ring-offset-2"
    >

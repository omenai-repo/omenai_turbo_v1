              ...
              <div className="flex flex-col items-center space-y-8">
                ...
                <div className="w-full pt-4">
                  <Link
                    ...
                    className={`group relative overflow-hidden h-12 px-4 rounded w-full flex items-center justify-center gap-3 font-medium text-white transition-all duration-300 transform hover:scale-101 text-fluid-xxs hover:shadow-xl ${
                      verified?.isOk

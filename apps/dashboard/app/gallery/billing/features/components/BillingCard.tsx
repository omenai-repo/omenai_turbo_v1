    ...
    <div className="bg-white rounded shadow-lg border border-slate-200 overflow-hidden">
      ...
      <div className="p-6">
        ...
        <Link
          ...
          className="w-fit gap-2 px-4 py-2 bg-dark text-white text-fluid-xs font-medium rounded shadow-sm transition-all transform active:scale-95 hover:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-slate-900 focus:ring-offset-2"
        >

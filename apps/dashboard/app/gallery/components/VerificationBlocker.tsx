      ...
      >
        <div className="bg-white text-dark dark:bg-[#0f172a] dark:text-white w-full text-center p-8">
          ...
          <p className="text-fluid-xxs text-gray-700 dark:text-gray-300 mb-6">
            Your Gallery account is currently under review. You&apos;ll be
            notified once your verification status is updated. In the meantime,
            access to dashboard features is currently restricted. Please check
            back later.
          </p>

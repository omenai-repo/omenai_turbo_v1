...
export default function OverviewOrdersCard({
  ...
  return (
    <div className="flex justify-between items-center px-5 py-3 rounded-sm  shadow w-full">
      ...
      <div className="flex flex-col items-end gap-y-2 text-fluid-xxs">
        ...
        <span className="text-amber-600 font-medium px-2 py-1 text-[12px] rounded-sm  bg-amber-200/50">
          PENDING
        </span>
      </div>
    </div>

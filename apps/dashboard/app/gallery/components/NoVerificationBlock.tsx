      ...
      <div className="flex flex-col gap-4 items-center text-[14px]">
        ...
        <div className="mt-3" id="gallery-verification">
          <button
            ...
            className=" h-[40px] p-6 rounded-full w-full flex items-center justify-center gap-3 disabled:cursor-not-allowed disabled:bg-dark/10 disabled:text-[#A1A1A1] bg-white text-dark hover:bg-[#e0e0e0] duration-300 text-[14px] font-normal"
          >

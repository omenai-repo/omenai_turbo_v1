...
export default function NoVerificationBlock({
  ...
  return (
    <div
      className={`w-full h-[78vh] grid place-items-center bg-dark mt-10 rounded-sm `}
    >
      <div className="flex flex-col gap-4 items-center text-fluid-xxs">
        ...
        <div className="mt-3" id="gallery-verification">
          <button
            ...
            className=" h-[35px] p-5 rounded-sm  w-full flex items-center justify-center gap-3 disabled:cursor-not-allowed disabled:bg-dark/10 disabled:text-[#A1A1A1] bg-white text-dark hover:bg-[#e0e0e0] duration-300 text-fluid-xxs font-normal"
          >

...
export default function NoSubscriptionBlock() {
  return (
    <div
      className={`w-full h-[75vh] grid place-items-center bg-dark mt-10 rounded-sm `}
    >
      <div className="flex flex-col gap-4 items-center">
        ...
        <Link href={"/gallery/billing/plans"} className="">
          <button className="bg-white whitespace-nowrap hover:bg-dark/80 hover:text-white disabled:cursor-not-allowed text-dark focus:ring ring-1 border-0 ring-dark/20 focus:ring-white duration-300 outline-none focus:outline-none disabled:bg-dark/10 disabled:text-white rounded-sm  h-[35px] p-5 w-full text-center text-fluid-xxs flex items-center justify-center hover:ring-white cursor-pointer">

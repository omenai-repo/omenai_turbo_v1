...
export default function WarningAlert() {
  return (
    <div className="relative overflow-hidden bg-rose-50 border border-rose-100 rounded-sm  p-5 sm:p-6 transition-all shadow-sm animate-in fade-in slide-in-from-bottom-2">
      {/* Subtle background gradient flare for a premium feel */}
      <div className="absolute top-0 right-0 -mt-8 -mr-8 w-32 h-32 bg-rose-500/5 rounded-sm  -full blur-2xl pointer-events-none"></div>

      <div className="flex items-start gap-4 relative z-10">
        {/* Icon Container */}
        <div className="flex-shrink-0 mt-0.5">
          <div className="w-10 h-10 flex items-center justify-center rounded-sm  -full bg-white border border-rose-200 text-rose-600 shadow-sm">

          ...
          <div className="bg-slate-50 rounded-sm  p-6 border border-slate-200">
            <div className="flex items-start justify-between gap-4">
              ...
              <button
                ...
                className="px-4 py-2 bg-slate-900 text-white text-fluid-xxs font-medium rounded-sm  hover:bg-slate-800 transition-colors focus:outline-none focus:ring-2 focus:ring-slate-900 focus:ring-offset-2"
              >
                Change Password
              </button>
            </div>
            ...
            <div className="bg-red-50 border border-red-200 rounded-sm  p-6">
              <div className="flex items-start justify-between gap-4">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-white border border-red-300 text-red-600 text-fluid-xxs font-medium rounded-sm  hover:bg-red-50 transition-colors focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2"
                >
                  Delete Account
                </button>
              </div>

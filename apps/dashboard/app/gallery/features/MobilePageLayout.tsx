...
import { galleryNavigationActions } from "@omenai/shared-state-store/src/gallery/gallery_navigation/GalleryNavigation";
      ...
      >
        <div className="flex flex-col">
          ...
          <div className="flex flex-col gap-y-8 mt-6">
            {/* General navigation */}
            <div>
              <h4 className={`text-dark font-normal text-[14px] `}>General</h4>
            ...
            {/* Account pages */}
            <div>
              <h4 className={`text-dark font-normal text-[14px]`}>Account</h4>
              <ul className="flex flex-col gap-y-1">

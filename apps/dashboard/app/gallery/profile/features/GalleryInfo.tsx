...
export default function GalleryInfo() {
  ...
  return (
    <div className="w-full max-w-4xl">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 my-8">
        <div className="flex items-center gap-6">
          ...
          <div className="relative group">
            ...
            <button
              ...
              className="absolute inset-0 bg-slate-900/75 opacity-0 group-hover:opacity-100 transition-opacity duration-200 rounded-2xl flex items-center justify-center"
            >
          ...
          <div className="flex-1">
            ...
            <button
              onClick={() => updateModal(true)}
              className="inline-flex items-center gap-2 px-4 py-2 bg-slate-900 text-white text-sm font-normal rounded-md hover:bg-slate-800 transition-colors focus:outline-none focus:ring-2 focus:ring-slate-900 focus:ring-offset-2"
            >
              <svg
                className="w-4 h-4"
                fill="none"

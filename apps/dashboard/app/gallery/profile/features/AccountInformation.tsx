...
export default function AccountInformation({ profile }: { profile: any }) {
  ...
  return (
    <div className=" animate-fadeIn">
      {/* Identity Header */}
      {/* ================= HERO ================= */}
      <div className="relative mb-10 rounded-sm  bg-gradient-to-br from-slate-900 to-slate-800 p-6 text-white overflow-hidden">
        ...
        <div className="relative flex items-center gap-8">
          ...
          <div className="relative group">
            <Image
              ...
              width={120}
              height={120}
              className="h-[120px] w-[120px] rounded-sm  object-cover ring-4 ring-white/20"
            />

            <button
              onClick={() => updateLogoModalPopup(true)}
              className="mx-4 absolute inset-0 flex items-center justify-center rounded-sm  bg-dark/60 opacity-0 group-hover:opacity-100 transition"
            >
              <span className="flex items-center flex-col gap-2 rounded-sm  bg-white p-2 text-xs font-normal text-slate-900">
          ...
          <div className="rounded-sm  bg-white p-6 shadow-sm">
            ...
            <div className="flex items-start justify-between gap-4">
              ...
              <button
                ...
                className="rounded-sm  bg-slate-100 px-4 py-2 text-xs font-medium text-slate-700 hover:bg-slate-200"
              >
          ...
          <div className="rounded-sm  bg-white p-8 shadow-sm">
            ...
            {!hasChanges && (
              <div className="mb-6 flex justify-center">
                <span className="rounded-sm  bg-slate-100 px-4 py-1.5 text-xs text-slate-600">
      ...
      {/* Floating Save Bar */}
      {hasChanges && (
        <div className="fixed bottom-6 left-1/2 z-10 w-[90%] max-w-xl -translate-x-1/2 rounded-sm  bg-slate-900 px-6 py-3 shadow-xl">

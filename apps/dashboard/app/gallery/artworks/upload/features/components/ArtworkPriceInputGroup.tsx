...
export default function ArtworkPriceInputGroup({
  ...
  return (
    <div className="my-10 w-full">
      ...
      {/* Main Card Container */}
      <div className="bg-white border border-slate-200 rounded-sm -sm  -xl p-6 shadow-sm">
        {/* Info Alert Box */}
        <div className="mb-8 bg-amber-50 border border-amber-100 rounded-sm -sm  -lg p-4 flex items-start gap-3">
          <div className="mt-1 min-w-[4px] h-[4px] rounded-sm -sm  -full bg-amber-500" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 items-end">
            ...
            <div className="lg:col-span-2 flex items-center justify-center pb-3">
              <button
                ...
                className="group relative h-10 w-10 flex items-center justify-center rounded-sm -sm  -full bg-dark text-white shadow-md hover:bg-black transition-all disabled:bg-slate-200 disabled:text-slate-400 disabled:shadow-none disabled:cursor-not-allowed"

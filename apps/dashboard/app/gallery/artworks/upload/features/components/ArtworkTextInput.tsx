    ...
    >
      ...
      {type === "textarea" && (
        <textarea
          ...
          rows={3}
          onChange={(e) => handleChange(e.target.value, name)}
          className="border px-2 ring-0 rounded-[10px]  disabled:cursor-not-allowed disabled:bg-dark/10 border-[#E0E0E0] w-full py-2 focus:border-none focus:ring-dark placeholder:font-light placeholder:text-[#858585] placeholder:text-fluid-xs"
        />
      )}
      {errorList.length > 0 &&

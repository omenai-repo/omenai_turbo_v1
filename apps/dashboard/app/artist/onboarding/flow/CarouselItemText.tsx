      ...
      {label === "bio" ? (
        <div>
          <textarea
            ...
            className="resize-none focus:ring ring-1 border-0 ring-dark/20 outline-none focus:outline-none focus:ring-dark transition-all duration-200 ease-in-out w-full p-4 rounded placeholder:text-dark/40 placeholder:text-fluid-xxs placeholder:font-normal text-fluid-xxs font-medium bg-[#fafafa]/50"
          />
        ...
        errorList.map((error, index) => {
          return (
            ...
            >
              ...
              <p className="text-red-600 text-fluid-xxs sm:text-fluid-xxs">{error}</p>
            </div>
          );
        })} */}
    </div>

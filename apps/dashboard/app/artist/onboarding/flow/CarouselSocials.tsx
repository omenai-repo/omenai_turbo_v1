          ...
          {["Instagram", "Twitter", "LinkedIn"].map((social) => {
            return (
              <input
                ...
                name={social}
                className="disabled:cursor-not-allowed disabled:bg-dark/10 focus:ring ring-1 border-0 ring-dark/30 outline-none focus:outline-none focus:ring-dark transition-all duration-200 ease-in-out text-fluid-xs font-medium h-[35px] p-5 rounded w-full placeholder:text-[12px] placeholder:text-dark/40 placeholder:font-light"
              />
            );
          })}
        </div>

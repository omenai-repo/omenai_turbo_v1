        ...
        <>
          ...
          <div className="w-full flex justify-between items-center gap-x-4 mb-2 mt-6">
            <Link href={"/artist/app/artworks/upload"} className="w-fit h-fit">
              <button className="h-[35px] p-5 rounded-xl w-full flex items-center justify-center gap-3 disabled:cursor-not-allowed disabled:bg-dark/10 disabled:text-[#A1A1A1] bg-white hover:bg-[#f1f1f1] text-dark ring-1 ring-dark text-fluid-xs font-normal whitespace-nowrap">
                Cancel
              </button>
            </Link>
            ...
            <button
              type="submit"
              disabled={loading}
              className="h-[35px] p-5 rounded-xl w-full flex items-center justify-center gap-3 disabled:cursor-not-allowed disabled:bg-dark/10 disabled:text-[#A1A1A1] bg-dark text-white text-fluid-xs hover:bg-dark/90 font-normal whitespace-nowrap"
            >

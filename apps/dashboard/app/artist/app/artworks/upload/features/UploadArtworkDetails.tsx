    ...
    <div className="">
      ...
      <form onSubmit={handleFormSubmit}>
        ...
        <div className="w-full flex justify-center mb-4 text-fluid-xs">
          <button
            type="submit"
            className="h-[35px] p-5 rounded-xl w-fit self-end flex items-center justify-end gap-3 disabled:cursor-not-allowed disabled:bg-dark/10 disabled:text-[#A1A1A1] bg-dark text-white text-fluid-xs font-normal"
          >
            Proceed
          </button>
        </div>

      ...
      <div className="p-6 space-y-3">
        ...
        <div className="flex justify-between items-end">
          ...
          <div>
            <button
              onClick={toggleForm}
              className="px-4 py-2 bg-white text-dark font-normal rounded-md shadow-sm transition-all transform active:scale-95 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-slate-900 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none text-fluid-xs"
            >

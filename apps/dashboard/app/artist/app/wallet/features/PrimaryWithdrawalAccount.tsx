          ...
          <div className="bg-slate-50 rounded-2xl border-2 border-dashed border-slate-300 p-8 text-center">
            <div className="max-w-sm mx-auto space-y-4">
              ...
              <Link
                ...
                className="inline-flex items-center gap-2 px-6 py-2 bg-slate-900 text-white font-medium rounded-md shadow-sm transition-all transform active:scale-95 focus:outline-none focus:ring-2 focus:ring-slate-900 focus:ring-offset-2"
              >
                <svg
                  className="w-5 h-5"
                  fill="none"

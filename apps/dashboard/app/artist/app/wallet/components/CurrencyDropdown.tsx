  ...
  return (
    <div className="relative inline-blocktext-left">
      ...
      <button
        ...
        className="flex gap-x-2 items-center gap-2 px-4 py-2 ring-1 border-0 bg-white ring-dark/10 text-fluid-xxs text-dark rounded hover:bg-gray-800 transition"
      >

  ...
  return (
    <div className="flex flex-col space-y-4">
      <div className="flex flex-col space-y-5">
        <p className="text-[14px] font-medium">Enter withdrawal amount</p>
        ...
        <div className="flex justify-center w-full my-4">
          <div className="flex flex-col items-center">
            <button className="h-[35px] p-4 rounded-full w-fit flex items-center justify-center gap-3 disabled:cursor-not-allowed disabled:bg-dark/10 disabled:text-[#A1A1A1] bg-dark text-white text-xs font-normal">
              <RefreshCcwDot size={20} strokeWidth={1.5} absoluteStrokeWidth />
            </button>
            <span className="text-xs">Click to convert</span>{" "}
          </div>
        </div>

        <Paper radius="lg" withBorder className="p-5 flex flex-col space-y-2">
          <p className="text-xs font-medium">You Get (FCFA)</p>
        ...
        <Paper radius="lg" withBorder className="p-5 flex flex-col space-y-2">
          ...
          <div className="flex flex-col space-y-4">
            ...
            <p className="text-red-600 font-medium text-xs text-center my-5">
              Forgot pin?
            </p>
          </div>
        </Paper>

    ...
    <div className="flex flex-col">
      ...
      <div className={clsx("flex items-center justify-between py-1")}>
        <textarea
          ...
          className={
            "p-3 border border-[#E0E0E0] text-fluid-xs placeholder:text-dark font-light placeholder:text-fluid-xs bg-white  w-full focus:border-none focus:ring-1 focus:ring-dark focus:outline-none rounded-[20px]"
          }
          {...rest}
        />
      </div>

    ...
    <div className="h-[calc(70vh-3rem)] grid place-items-center">
      <div className="flex items-center justify-center gap-x-4">
        ...
        <button
          ...
          className="h-[35px] p-5 rounded-full w-fit flex items-center justify-center gap-3 disabled:cursor-not-allowed disabled:bg-dark/10 disabled:text-[#A1A1A1] bg-red-600 hover:bg-red-500 text-white text-fluid-xs font-normal"
        >
          Delete my account
        </button>
      </div>

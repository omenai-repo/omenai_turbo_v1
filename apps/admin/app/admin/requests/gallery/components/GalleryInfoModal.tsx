...
export function GalleryInfoModal({
  ...
  const InfoRow = ({
    ...
    <div className="flex items-center space-x-4 p-2 rounded bg-gray-50 hover:bg-gray-100 transition-colors duration-200">
      <div
        className={`w-12 h-12 ${bgColor} rounded flex items-center justify-center flex-shrink-0`}
      >
        {icon}
      </div>
  ...
  return (
    ...
    >
      <div className="relative">
        {/* Main modal content */}
        <div className="relative bg-white rounded shadow-2xl overflow-hidden border border-gray-100">
          ...
          <div className="relative bg-gray-50 border-b border-gray-100">
            ...
            <div className="p-6 text-center">
              ...
              <div className="relative mx-auto w-16 h-16 mb-3">
                <div className="absolute inset-0 bg-white rounded shadow-lg" />

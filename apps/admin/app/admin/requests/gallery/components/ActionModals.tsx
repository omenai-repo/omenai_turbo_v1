    ...
    >
      <div className="relative p-3">
        ...
        <div className="flex justify-center mb-6">
          <div
            className={`w-16 h-16 rounded flex items-center justify-center shadow-lg bg-gradient-to-br ${config.gradient}`}
          >
        ...
        <div className="text-center mb-2">
          ...
          <div
            className={`w-16 h-1 mx-auto rounded bg-gradient-to-r ${config.barGradient}`}
          />
        </div>
        ...
        <Group justify="center" gap="md">
          <Button
            ...
            className={`px-4 py-2 text-fluid-xxs font-semibold transition-all duration-300 transform hover:scale-105 bg-gradient-to-r ${config.buttonGradient} ${config.shadowColor} text-white shadow-lg hover:shadow-xl`}
            leftSection={<IconComponent size={18} strokeWidth={2} />}
          >
            {config.buttonText}
          </Button>

        ...
        <form className="flex-1" onSubmit={handleEditorialUpload}>
          <div className="w-full flex flex-col gap-4">
            ...
            <button
              disabled={loading}
              type="submit"
              className={`whitespace-nowrap bg-dark text-[14px] disabled:bg-dark/10 disabled:text-[#858585] rounded-sm w-full text-white disabled:cursor-not-allowed h-[40px] px-4 flex gap-x-2 items-center justify-center hover:bg-dark/80 mt-5`}
            >

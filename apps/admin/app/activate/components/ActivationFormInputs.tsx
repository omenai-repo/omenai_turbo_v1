    ...
    <form className="flex flex-col gap-y-5" onSubmit={handleSubmit}>
      <div className="flex flex-col">
        <input
          ...
          className="focus:ring ring-1 border-0 ring-dark/20 outline-none focus:outline-none focus:ring-dark transition-all duration-200 ease-in-out h-[35px] p-5 rounded placeholder:text-dark/40 placeholder:text-fluid-xs placeholder:font-normal text-fluid-xs font-medium"
      ...
      <div className="flex flex-col space-y-4">
        <div className="w-full relative">
          <input
            ...
            className="relative w-full focus:ring ring-1 border-0 ring-dark/20 outline-none focus:outline-none focus:ring-dark transition-all duration-200 ease-in-out h-[35px] p-5 rounded placeholder:text-dark/40 placeholder:text-fluid-xs placeholder:font-normal text-fluid-xs font-medium"
            onChange={handleChange}
          />
        </div>
          ...
          errorList.map((error, index) => {
            return (
              ...
              >
                ...
                <p className="text-red-600 text-fluid-xs sm:text-fluid-xs">
                  {error}
                </p>
              </div>
            );

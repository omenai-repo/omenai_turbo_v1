    ...
    <div className="group relative bg-white rounded-3xl ring-1 ring-dark/10 overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-1 h-[420px] max-w-[320px] min-w-[300px] xxl:w-full w-[300px] xxm:w-[350px] xxm:max-w-[350px] border border-gray-100">
      ...
      <div className="p-6 flex flex-col justify-between h-[200px] bg-white">
        ...
        <div className="flex items-center gap-4 mt-auto">
          ...
          >
            <button className="bg-gray-900 text-white px-6 py-2.5 rounded-full text-sm font-medium hover:bg-gray-800 transition-all duration-300 hover:scale-105 shadow-md hover:shadow-lg whitespace-nowrap group-hover:bg-black">
              Read Article
            </button>
          </Link>

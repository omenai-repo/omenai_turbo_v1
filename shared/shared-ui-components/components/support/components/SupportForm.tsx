      ...
      <div className="space-y-2">
        ...
        <div className="relative">
          <button
            ...
            className="appearance-none w-full bg-slate-50/50 border border-slate-200/60 text-dark text-sm rounded focus:border-slate-400 focus:bg-white focus:ring-0 block px-4 py-3 outline-none transition-all font-normal text-left flex items-center justify-between"
          >
          ...
          {dropdownOpen && (
            <>
              ...
              />
              <div className="absolute z-20 w-full my-2 bg-white border border-slate-200/60 rounded shadow-[0_8px_30px_-4px_rgba(0,0,0,0.12)] overflow-hidden backdrop-blur-xl max-h-60 overflow-y-auto">

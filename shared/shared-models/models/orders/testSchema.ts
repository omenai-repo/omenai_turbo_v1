...
const PaymentInformationSchema = new Schema({
  ...
  transaction_value: { type: Number, required: true, default: 0 },
  transaction_date: { type: String, required: true, default: "" },
  transaction_reference: { type: String, required: true, default: "" },
  artist_wallet_increment: { type: Number || null, default: null },
});

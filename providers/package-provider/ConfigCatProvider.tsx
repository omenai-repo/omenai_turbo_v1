...
const highRiskSdkKey = process.env
  .NEXT_PUBLIC_CONFIGCAT_HIGH_RISK_SDK_KEY as string;

const lowRiskSdkKey = process.env
  .NEXT_PUBLIC_CONFIGCAT_LOW_RISK_SDK_KEY as string;
